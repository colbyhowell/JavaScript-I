...
console.log(`This is a ${inventory[32].car_model} made by ${inventory[32].car_make} in the year ${inventory[32].car_year} ` );
...
for(i = 0; i < inventory.length; i++){
  let modelList = inventory[i].car_model
  carModels.push(modelList)
  carModels.sort()
}
...
for(i = 0; i < inventory.length; i++){
  let modelYears = inventory[i].car_year
  carYears.push(modelYears)
}
